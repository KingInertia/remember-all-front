...
const LeftMenu = ({notesHistory}:NoteProps) => {
  ...
  <div className="flex flex-col items-center ">
    <div>
      <img onClick={()=>navigate('/')} src={bookImg} alt="" className=' h-[50px]  rounded-xl opacity-95 cursor-pointer scale-105 transition-transform hover:scale-100'/>
    </div>
  </div>

   <div className="flex-1 rounded-4xl border-2 border-primary/90 bg-blockNoteMenu/75 p-4 text-textWhite mt-3">
        <h2 className="text-lg font-semibold mb-3 flex justify-center">Recent Notes</h2>
