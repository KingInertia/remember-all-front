...
setLoadingState(LOADINGSTATES.IDLE);
  ...
  return (
      <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
           ...
           {loadingState != LOADINGSTATES.LOADING ? (<form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                <input type="text" name='username' placeholder='Login' className='p-3 rounded-lg bg-black/50 border-2 border-primary text-white outline-none focus:border-white duration-200 placeholder:text-white placeholder:opacity-50'/>
                <input type="password" name='password' placeholder='Password' className='p-3 rounded-lg bg-black/50 border-2 border-primary text-white outline-none focus:border-white duration-200 placeholder:text-white placeholder:opacity-50'/>
            ...
            </form>):(<h1 className='text-center text-white'>Loading...</h1>)}
