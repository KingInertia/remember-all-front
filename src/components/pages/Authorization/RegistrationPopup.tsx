  ...
  return (
    <div
      className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                        ...
                        flex flex-col gap-6"
    >
      <h1 className="text-4xl text-center text-textWhite puzzle-img">
        Registration
      </h1>
      ...
      {loadingState === LOADINGSTATES.SUCCESS ? (
        ...
        <form
          ...
          className="flex flex-col gap-4 text-textWhite"
        >
          <input
            name="login"
            id="login"
            placeholder="Username"
            className="p-3 rounded-lg bg-black/50 border-2 border-primary  outline-none focus:border-white duration-200 placeholder:text-textWhite placeholder:opacity-50"
          />
          <input
            name="email"
            id="email"
      ...
      {loadingState === LOADINGSTATES.LOADING && (
        <div className="text-center text-textWhite">Loading...</div>
      )}
